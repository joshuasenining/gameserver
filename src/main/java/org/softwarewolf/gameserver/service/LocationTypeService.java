...
import org.softwarewolf.gameserver.domain.GameDataType;
...
//		locationTypeCreator.setOtherGameDataTypes(otherGameDataTypes);
	...
	public boolean removeLocationType(String removeLocationTypeId) {
		List<Location> locations = locationService.findAllByKeyValue("gameDataTypeId", removeLocationTypeId);
		if (locations == null || locations.isEmpty()) {
			LocationType locationType = locationTypeRepository.findOne(removeLocationTypeId);
			locationTypeRepository.delete(locationType);
			return true;
		}
		return false;
