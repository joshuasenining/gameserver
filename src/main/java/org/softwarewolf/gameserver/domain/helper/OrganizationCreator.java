...
public class OrganizationCreator {
	...
	public Boolean createOrganizationTag;
	public Boolean createOrganizationTypeTag;
	...
	public Boolean getCreateOrganizationTag() {
		return createOrganizationTag;
	}
	
	public void setCreateOrganizationTag(Boolean createOrganizationTag) {
		this.createOrganizationTag = createOrganizationTag;
	}
	
	public Boolean getCreateOrganizationTypeTag() {
		return createOrganizationTypeTag;
	}
	
	public void setCreateOrganizationTypeTag(Boolean createOrganizationTypeTag) {
		this.createOrganizationTypeTag = createOrganizationTypeTag;
	}
}
