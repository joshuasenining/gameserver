...
public class OrganizationRankCreator {
	...
	public Boolean createOrganizationRankTag;
	...
	public Boolean getCreateOrganizationRankTag() {
		return createOrganizationRankTag;
	}
	
	public void setCreateOrganizationRankTag(Boolean createOrganizationRankTag) {
		this.createOrganizationRankTag = createOrganizationRankTag;
	}
}
